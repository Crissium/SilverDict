...
- Morphology analysis (word stemming & spelling suggestions) is disabled unless you have installed the Python package `hunspell`, which could be non-trivial on some platforms.
